 ...
 */
final class Version20220221194133 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD image VARCHAR(255) DEFAULT NULL, CHANGE nom nom VARCHAR(255) NOT NULL');
    }
